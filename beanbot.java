...
//-----//-----//-----// Config Methods //-----//-----//-----//
  public static void parse_arguments(String args[]) {
	...
	System.out.println("		java beanbot --config foo.txt\n");
	System.out.println("--staydead	The bot will not automatically reconnect.");
	System.out.println("		java beanbot --staydead\n");
	System.out.println("--help		Displays this help.");
	System.out.println("		java beanbot --help\n");
